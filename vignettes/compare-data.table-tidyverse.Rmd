...
aplot(atime.list, "Write CSV with 10 random normal real columns", 1e7, "Number of rows")+scale_color_manual(values=some.colors)+scale_fill_manual(values=some.colors)
```
