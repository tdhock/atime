...
We also use `results=FALSE` in the code below to save memory (in the
case there is no need to store the result of evaluating `expr` for
...
(atime.list <- atime::atime_versions(
  ...
  results = FALSE,
  verbose = TRUE,
  ".dev-only: revdep tweaks"="3fa8b20435d33b3d4b5c26fd9b0ac14c10b98800",
  "Internal class aware coerceAs.\nAlready used in nafill and froll (#4491)"="85adf09e3463838d547977ae9bc75e3b37f9cbaf",
  ##reshape2clarify4908="788c585586798107f9eeb3263928f718ca1db81e",
  ##fread_docs4745="8f425c69279eef8b743bb049c7c983e0b6f3543e",
  ##fread_nrows0L4694="374e20813f652b9f1729d26da1bad902979b06d6",
  ##scalar_logical4928="10463e32613bb9b400e54179d2ac92e655b22701",
  ##gmin_blank4847="45b8277e1cafe29a0e446d034185d6090b525e41",
  ##typo_in_link="a7325a38d7cfe072164c477e053bdefb18bdd8f8",
...
The figure above shows that there is a significant difference between
the timings of the commits. 

* commits labeled .dev-only and 1.14.0 on CRAN are fast (relatively
  small computation time),
* commits labeled 1.14.3 dev master and
  [#4491](https://github.com/Rdatatable/data.table/pull/4491) are slow
  (relatively large computation time).
* since commit #4491 occured immediately after .dev-only, we can
